...
namespace XJeunot.PhysicalStoreApps.BuildingBlocks.EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        const string BROKER_NAME = "physicalstore_event_bus";
        ...
        private IModel CreateConsumerChannel()
        {
            ...
            consumer.Received += (model, ea) =>
            {
                ...
                if (ProcessEvent(eventName, message).Result)
